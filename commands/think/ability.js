    ...
    for (var i = 0; i < abilityDB.length; i++) {
      if (abilityName == abilityDB[i]._ability.toLowerCase()) {
        ...
        message.channel.send({
          content: `**${message.author.username}** here is the information your requested about **${abilityDB[i]._ability}**:`,
          embeds: [Embed],
        });
        ...
        message.channel.send(
          `${message.author.username} I'm sorry your having trouble. Please refer to !help for commands, check your spelling, or ping/dm camckee`
        );
    }
    //
  },
